...
option_list <- list(
  make_option(c("--indel-baseline-method"), action = "store", 
	      ...
	      help = paste(sep=" ",
	                   "Baseline method for indel",
			   "(one of 'runmed','runmed_quadratic', 'quadratic',", 
			   "or 'runmin_quadratic')")),
  make_option(c("--indel-runmed-k"), action = "store",
  	      type = "integer", default = 25, metavar = "k",
	      help = paste(sep=" ",
  ...
  make_option(c("--base-content-baseline-method"), action = "store",
	      ...
	      help = paste(sep=" ",
	                   "Baseline method for base content deviation",
  ...
  make_option(c("--quality-dropoff-ignore-edge-cycles"), action = "store", 
              type = "integer", default = 3, metavar = "cycle-count",
	      help = paste(sep=" ",
